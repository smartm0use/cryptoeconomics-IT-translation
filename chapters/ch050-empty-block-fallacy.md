...
* Una [ricompensa](ch101-glossary.md#ricompensa-reward) di un blocco è costituita dalle [commissioni](ch101-glossary.md#commissione-di-transazione-fee) per le [transazioni](ch101-glossary.md#transazione) e da un [sussidio](ch101-glossary.md#sussidio-subsidy) per il blocco. Il [miner](ch101-glossary.md#miner) che rinuncia alle commissioni delle transazioni non includendole in un blocco non è remunerato da esse.
* L'[_hash power_](ch101-glossary.md#hash-power) del miner contribuisce in maniera proporzionale alla sicurezza del network. Il sussidio rappresenta la compensazione per la sicurezza durante la fase [inflazionaria](ch101-glossary.md#inflazione). Lo scopo dell'inflazione è quello di distribuire razionalmente le [unità](ch101-glossary.md#unità). La distribuzione razionale è [scambiata](ch101-glossary.md#scambio-di-unità-exchange) specificamente in cambio di _hash power_, non al fine di includere transazioni.
...
* I blocchi vuoti sono totalmente compatibili con le [regole del consenso](ch101-glossary.md#regole-di-consenso) e non possono essere ragionevolmente impediti da una nuova [regola](ch101-glossary.md#regola).
